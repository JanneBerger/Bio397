...
# ╔═╡ 6a02209c-11e6-4b94-92ef-34ae5d1d652e
...
# ╔═╡ 55d8a7da-b394-4518-9b6d-29dd21c6c577
train_X, test_X = RobustScaler().fit_transform(Matrix{Float64}(df_train_X)), RobustScaler().fit_transform(Matrix{Float64}(df_test_X))
...
model = fit!(RandomForestClassifier(min_samples_split=8),train_X,train_y)
