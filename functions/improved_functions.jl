...
function final_function_train4(dataframe)
    ...
    final_data = select(final_data, [:"Age", :"Relatives", :"pclass_3", :"pclass_2", :"pclass_1", :"sex_male", :"sex_female", :"Fare", :"embarked_Q", :"embarked_S", :"embarked_C", :"cabin_A", :"cabin_B", :"cabin_C", :"cabin_D", :"cabin_E", :"cabin_F", :"cabin_G", :"cabin_U", :"cabin_T"])
...
data, y = final_function_train4(df_train)
#names(data)
